...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("AddressBook")));
bytes32 constant AddressBookTableId = _tableId;
...
library AddressBook {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("AddressBook", _fieldNames);
  }
